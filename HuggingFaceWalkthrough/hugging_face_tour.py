...
def reflection_test():
    api = HfApi()
    models = list(api.list_models(filter=["library:coreml"]))
    print(models)

    # How do we get a list of all models?
    # config = AutoConfig.from_pretrained("google-bert/bert-base-uncased", cache_dir="E:\\Models\\Configs")

    #bart_config = BartConfig()
    #print(json.dumps(vars(bart_config)))


    #property_names = [p for p in dir(BartConfig) if isinstance(getattr(BartConfig, p), property)]
...
def export_model_onnx():
    ...
    save_directory = "E:\\Models\\bart-large-test"
